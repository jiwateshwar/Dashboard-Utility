...
export default function DashboardDetailPage() {
  ...
  async function saveTask(taskId: string) {
    ...
    try {
      ...
      setTaskEdits((prev) => { const copy = { ...prev }; delete copy[taskId]; return copy; });
      await refresh();
    } catch (err: any) {
      setError(err.message);
    }
  ...
  async function saveRisk(riskId: string) {
    ...
    try {
      ...
      setRiskEdits((prev) => { const copy = { ...prev }; delete copy[riskId]; return copy; });
      await refresh();
    } catch (err: any) {
      setError(err.message);
    }
  ...
  async function saveDecision(decisionId: string) {
    ...
    try {
      ...
      setDecisionEdits((prev) => { const copy = { ...prev }; delete copy[decisionId]; return copy; });
      await refresh();
    } catch (err: any) {
      setError(err.message);
    }
  ...
  return (
    <div className="dashboard-shell">
      ...
      {/* Header — real dashboard name and description */}
      ...
      {/* Summary highlight sections — vertically stacked */}
      ...
      {/* Tasks card — full width, create form inline */}
        ...
        {showCreateTask && (
          <div className="inline-create-panel">
            <div className="form-row">
              ...
              <input className="input" type="date" placeholder="Target date" value={newTask.target_date} onChange={(e) => setNewTask({ ...newTask, target_date: e.target.value })} />
      ...
      {/* Risks card — full width, create form inline */}
      <div className="card" style={{ marginBottom: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
      ...
      {/* Decisions card — full width, create form inline */}
      <div className="card" style={{ marginBottom: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
